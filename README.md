...
```bash
pip install git+https://github.com/smjc-org/py-submit.git@0.6.1
```

或者从特定 commit 安装：

```bash
pip install git+https://github.com/smjc-org/py-submit.git@7b6edc9b2e88a60749fe9c8cc35bae9f93cf3cd0
```
